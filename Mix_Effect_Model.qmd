...
As we can see, this is far from a normal distribution. This suggests the use of a GLM perhaps. First, let's investigate observations above "rides" = 20,000 for potential incorrect data.
